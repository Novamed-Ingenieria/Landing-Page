...
type Variant = 'primary' | 'secondary' | 'outline' | 'outline-dark' | 'ghost' | 'white';
type Size = 'md' | 'lg';
...
const variants: Record<Variant, string> = {
  ...
  white: 'bg-white text-primary hover:bg-white/90 shadow-[var(--elevation-2)] hover:shadow-[var(--elevation-3)]',
};
