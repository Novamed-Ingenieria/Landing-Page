...
export const plans = [
  ...
  },
  {
    ...
    highlight: ['Programa de Mtto preventivo', 'Programa de verificaciones metrológicas'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    features: [
      ...
      'Programa de Mtto preventivo',
      'Programa de verificaciones metrológicas',
      'Procedimiento de Mtto preventivo',
      'Procedimiento de Mtto correctivo',
    ...
    cardFeatures: [
      ...
      'Procedimientos de Mtto y verificaciones',
    ],
    highlight: ['Soporte priorizado', 'Procedimientos de Mtto y verificaciones'],
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    featureValues: { 'Capacitación virtual': 'Personalizado' },
    cardFeatures: [
      'Inventario de equipos',
      'Hojas de vida',
      'Gestión documental',
